...
solution to fix outliers: <https://www.geeksforgeeks.org/ignore-outliers-in-ggplot2-boxplot-in-r/>
...
geom_bar() makes the height of the bar proportional to the number of cases in each group.It counts the number of cases at each x position. Source: <https://ggplot2.tidyverse.org/reference/geom_bar.html>
...
seq() controls the x-axis range; start:40, end:85, and width of the bar:2.5, respectively.
